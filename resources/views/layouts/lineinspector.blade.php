                    ...
                    <div class="header-left">
                        <form type="get" action="{{url('/search')}}">
                            <div class="input-group search-area right d-lg-inline-flex d-none">
                                <input type="text" class="form-control" name="query" placeholder="Find something here...">
                                <div class="input-group-append">
                        ...
                        <li class="nav-item dropdown header-profile">
                            <a class="nav-link" href="#" role="button" data-toggle="dropdown">
                                ...
                                <div class="header-info">
                                    <span>{{$inspector->nom}}</span>
                                    <small>Lineinspector</small>
                                </div>
                            </a>
                            <div class="dropdown-menu dropdown-menu-right">
                                ...
                                <a class="dropdown-item ai-icon"><form action="{{route('inspector_logout')}}" method="POST">
                                        @csrf
                                        <i class="icon-logout fa-fw"></i><input  type="submit" value="Logout"><span class="ml-2">logout </span>
    ...
    <div class="deznav">
        <div class="deznav-scroll">
            <div class="main-profile">
              ...
              <h5 class="mb-0 fs-20 text-black "><span class="font-w400">Hello,</span> {{$inspector->nom}} {{$inspector->prenom}}</h5>
               <p class="mb-0 fs-14 font-w400">{{$inspector->matricule}}</p>
            </div>
